...
81:i_0_EQ	mov  T196, dx
	...
	jne  82:i_T196_OR
	mov  dx, 0
82:i_T196_OR	mov  T197, dx
	mov  dx, 1
	mov  ax, n
	cmp  ax, T197
	je  83:n_T197_EQ
	mov  dx, 0
83:n_T197_EQ	mov  T198, dx
	mov  ax, T198
	cmp  ax, 0
	je  84:T198__EZ
	jmp  far ptr 8
